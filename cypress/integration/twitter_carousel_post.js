...
describe('Test twitter image caption page.', function () {
  it('Select page and assert url', function () {
    ...
    cy.url().should('eq', Cypress.env('Test_env') + '/' + this.data[3].url + '/')
  })
  ...
  it('Visit the page with user id', function () {
    cy.visit('https://testing.inkforall.com/tools/twitter-carousel-post/?code=4ds34s-231sed2-123sde-32s2332')
